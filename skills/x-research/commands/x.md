...
Default behavior:
- If no argument was provided, ask for the X/Twitter research target. Do not run a default topic.
...
- Before any broad research run, show a compact research plan: objective, exact time window, source mix, candidate probes, paper/project verification path if relevant, and deliverable shape.
