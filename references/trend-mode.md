...
```bash
uv run ~/.claude/skills/x-cli/scripts/digest.py --scan
```
...
```bash
uv run ~/.claude/skills/x-cli/scripts/digest.py --drill <trend_id>
```
...
```bash
uv run ~/.claude/skills/x-cli/scripts/read.py --user-articles <handle>
```
